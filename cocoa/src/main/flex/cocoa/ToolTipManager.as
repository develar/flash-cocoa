 ...
 * в результате чего начинает мерцать (так раз он под мышей, он тут же пропадает, а потом тут же появляется) — он должен позиционировать при нехватке места над bounds мыши/края контрола 
 */
