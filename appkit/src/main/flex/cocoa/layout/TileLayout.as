...
public class TileLayout extends LayoutBase implements VirtualLayout
{
	...
	{
		return visibleStartIndex == -1 ? _firstIndexInView : visibleStartIndex;
	}

	private var _lastIndexInView:int;
	public function get lastIndexInView():int
    {
        return visibleEndIndex == -1 ? _lastIndexInView : visibleEndIndex;
    }
	...
	override public function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
	{
		...
		if (useVirtualLayout)
		{
			_firstIndexInView = visibleStartIndex;
			_lastIndexInView = visibleEndIndex;
