...
public class TextAreaUIModel extends TextUIModel {
   ...
   *  the height to be sufficient to display five lines of text.</p>
   *
   ...
   *  constraints.</p>
   *
   *  <p><code>measure()</code> method uses <code>widthInChars</code> and <code>heightInLines</code>
   *  to determine the <code>measuredWidth</code> and <code>measuredHeight</code>.
   *  These are similar to the <code>cols</code> and <code>rows</code> of an HTML TextArea.</p>
   *
   * <p>Since both <code>widthInChars</code> and <code>heightInLines</code> default to <code>NaN</code>,
   * "autosizes" by default:
